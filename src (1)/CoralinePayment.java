...
public class CoralinePayment extends JPanel implements Printable {
    ...
    public CoralinePayment(String movieName, double price, String selectedDate, String selectedTime, String seatDetails) {
        ...
        printButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                printerJob.setPrintable(CoralinePayment.this);
        ...
        backButton.addActionListener(e -> {
            JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(CoralinePayment.this);
            frame.dispose();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Coraline Payment");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            CoralinePayment paymentPanel = new CoralinePayment("Coraline", 300.00, "2023-06-01", "10:00 AM", "A4");
