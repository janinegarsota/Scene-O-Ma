...
public class MeanGirlsPayment extends JPanel implements Printable {
    ...
    public MeanGirlsPayment(String movieName, double price, String selectedDate, String selectedTime, String seatDetails) {
        ...
        printButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                printerJob.setPrintable(MeanGirlsPayment.this);
        ...
        backButton.addActionListener(e -> {
            JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(MeanGirlsPayment.this);
            frame.dispose();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Mean Girls Payment");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            MeanGirlsPayment paymentPanel = new MeanGirlsPayment("Mean Girls", 300.00, "2023-06-01", "10:00 AM", "A4");
